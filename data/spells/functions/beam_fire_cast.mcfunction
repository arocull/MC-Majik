...
execute if score @s mana matches 4.. if entity @e[tag=spell_beam_fire] as @s positioned ~ ~1.25 ~ positioned ^ ^ ^2 run function spells:beam_fire
execute if score @s mana matches 4.. if entity @e[tag=spell_beam_fire] run scoreboard players set @s beam_length 0

execute if score @s mana matches 6.. if entity @e[tag=spell_beam_fire] if entity @s[tag=spell_shape_projectile] as @s positioned ~ ~1 ~ positioned ^ ^ ^2 run function spells:beam_fire_fireball
