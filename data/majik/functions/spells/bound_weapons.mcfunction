...
item entity @a[tag=hold_projectile] weapon.offhand replace snowball{IsMagical:1b}
...
item entity @a[tag=hold_bound_weapon,tag=!spell_earth,tag=!spell_wind] weapon.mainhand replace stone_sword{IsMagical:1b,Damage:137,RepairCost:100000,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1}],display:{Name:'{"text":"Bound Sword","color":"gray","italic":true,"obfuscated":true}'}}
item entity @a[tag=hold_bound_weapon,tag=spell_earth,tag=!spell_wind] weapon.mainhand replace stone_sword{IsMagical:1b,Damage:137,RepairCost:100000,Enchantments:[{id:"minecraft:sharpness",lvl:2},{id:"minecraft:vanishing_curse",lvl:1}],display:{Name:'{"text":"Bound Sword","color":"gray","italic":true,"obfuscated":true}'}}
item entity @a[tag=hold_bound_weapon,tag=!spell_earth,tag=spell_wind] weapon.mainhand replace stone_sword{IsMagical:1b,Damage:137,RepairCost:100000,Enchantments:[{id:"minecraft:knockback",lvl:1},{id:"minecraft:vanishing_curse",lvl:1}],display:{Name:'{"text":"Bound Sword","color":"gray","italic":true,"obfuscated":true}'}}
item entity @a[tag=hold_bound_weapon,tag=spell_earth,tag=spell_wind] weapon.mainhand replace stone_sword{IsMagical:1b,Damage:137,RepairCost:100000,Enchantments:[{id:"minecraft:sharpness",lvl:2},{id:"minecraft:knockback",lvl:1},{id:"minecraft:vanishing_curse",lvl:1}],display:{Name:'{"text":"Bound Sword","color":"gray","italic":true,"obfuscated":true}'}}
