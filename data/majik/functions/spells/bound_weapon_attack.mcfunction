...
execute if entity @s[tag=spell_earth] if score @s mana matches 1.. run scoreboard players remove @s mana 1
execute if entity @s[tag=spell_wind] if score @s mana matches 1.. run particle cloud ~ ~1 ~ 0.25 0.5 0.25 0 10 normal
execute if entity @s[tag=spell_wind] if score @s mana matches 1.. run scoreboard players remove @s mana 1
...
execute if entity @s[tag=spell_fire] if score @s mana matches 1.. run scoreboard players remove @s mana 1
...
execute if entity @s[tag=spell_frost] if score @s mana matches 1.. run scoreboard players remove @s mana 1
...
execute if entity @s[tag=spell_lightning] if score @s mana matches 3.. run scoreboard players remove @s mana 3
...
execute if entity @s[tag=spell_nature,tag=MajikLifestealHit] if score @s mana matches 2.. at @s run function majik:spells/casting/self_nature
execute if entity @s[tag=spell_nature,tag=MajikLifestealHit] if score @s mana matches 2.. run scoreboard players add @s xp 1
execute if entity @s[tag=spell_nature,tag=MajikLifestealHit] if score @s mana matches 2.. run scoreboard players remove @s mana 2
...
execute if entity @s[tag=spell_ender] if score @s mana matches 2.. run scoreboard players remove @s mana 2
