...
execute if entity @e[tag=spell_beam_lightning] as @e[tag=spell_beam_lightning] run data modify entity @s Invulnerable set value 1b
execute if entity @e[tag=spell_beam_lightning] facing entity @e[type=item,tag=spell_beam_lightning,sort=nearest,limit=1] feet positioned ^ ^ ^1 run function majik:spells/casting/beam_lightning
