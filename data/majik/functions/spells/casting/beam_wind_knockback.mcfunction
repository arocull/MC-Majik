...
scoreboard players add @s vy1 300

execute as @s store result entity @s Motion[0] double 0.0022 run scoreboard players get @s vx1
execute as @s store result entity @s Motion[1] double 0.0022 run scoreboard players get @s vy1
execute as @s store result entity @s Motion[2] double 0.0022 run scoreboard players get @s vz1

particle minecraft:sweep_attack ~ ~ ~ 0 0 0 0 1 force
execute if entity @s[type=!item] run playsound minecraft:entity.ender_dragon.flap player @a ~ ~ ~ 1.5 1.3