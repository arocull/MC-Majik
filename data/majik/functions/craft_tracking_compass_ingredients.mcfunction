...
execute as @e[sort=nearest,limit=1,tag=SpellIngredientEligible,nbt={Item:{id:"minecraft:allium"}}] at @s run function majik:confirm_ingredient
execute as @e[sort=nearest,limit=1,tag=SpellIngredientEligible,nbt={Item:{id:"minecraft:blue_orchid"}}] at @s run function majik:confirm_ingredient
execute as @e[sort=nearest,limit=1,tag=SpellIngredientEligible,nbt={Item:{id:"minecraft:note_block"}}] at @s run function majik:confirm_ingredient
