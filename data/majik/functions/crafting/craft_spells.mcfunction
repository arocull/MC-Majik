...
execute if entity @s[nbt={Item:{id:"minecraft:writable_book",tag:{pages:["aura"]}}}] run tag @s add spell_shape_aura
...
execute if entity @s[tag=spell_shape_aura] run tag @s add spell_level_two
