execute as @e[type=item_frame,nbt={Item:{id:"minecraft:compass"}},nbt=!{Item:{tag:{MajikTrackingCompass:1b}}}] at @s if block ~ ~-1 ~ lapis_block run function majik:crafting/craft_tracking_compass_ingredients
