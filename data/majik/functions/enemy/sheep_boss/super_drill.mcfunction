summon item ~ ~ ~ {Tags:["SpellScroll","CanAge","spell_fireball_barrage","spell_freeze_charging","spell_blast_charing"],Age:0s,Item:{id:"minecraft:paper",Count:1b},Motion:[0.0,0.5,0.0]}
