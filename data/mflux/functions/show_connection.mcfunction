...
execute if entity @a[tag=RevealMagic,distance=..10] run particle mycelium ~ ~1.25 ~ 0 0 0 0 1 normal
...
execute if score @s beam_length matches ..40 positioned ^ ^ ^.3 run function mflux:show_connection
