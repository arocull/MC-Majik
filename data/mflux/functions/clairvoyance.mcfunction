execute as @e[gamemode=!spectator,type=!item,type=!item_frame,type=!boat,type=!armor_stand,distance=..10,nbt=!{ActiveEffects:[{Id:24b,ShowParticles:1b}]}] at @s run function mflux:reveal_entity
