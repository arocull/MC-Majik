...
execute as @e[type=#majik:projectile,distance=..7] at @s run function mflux:repel_entity
...
execute if score @s xp matches 10.. run scoreboard players remove @s flux 1
execute if score @s xp matches 10.. run scoreboard players set @s xp 0
